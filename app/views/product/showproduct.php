...
<a href="<?php echo URLROOT; ?>/Produits/store" class="btn btn-light"><i class="fa fa-backward"></i> Arrière</a>
<br>
...
<form class="pull-right" action="<?php echo URLROOT; ?>/Produits/addtocart/<?php echo $data['product']->id_product; ?>" method="post">
