...
<h4 style="border:0.5px solid; width: 20%;background-color: #FFF5EB;text-align: center;"><?php echo $data['product']->prod_prix; ?>DH</h4>
  ...
  <hr>
  <a href="<?php echo URLROOT; ?>/Produits/edit/<?php echo $data['product']->id_product; ?>" class="btn btn-dark">Edit</a>

  <form class="pull-right" action="<?php echo URLROOT; ?>/Produits/delete/<?php echo $data['product']->id_product; ?>" method="post">
